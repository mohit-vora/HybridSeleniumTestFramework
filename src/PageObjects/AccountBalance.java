...
public class AccountBalance {
	public static void VerifyAccountBalance(WebDriver driver) {
		...
		if (driver.findElement(By.xpath("html/body/div[2]/div/div/div/div[3]/table/tbody/tr[1]/td[1]")).getText()
				.contains("My accounts")) {
			WebElement Accntypes = driver
					.findElement(By.xpath("html/body/div[2]/div/div/div/div[3]/table/tbody/tr[2]/td/table"));
