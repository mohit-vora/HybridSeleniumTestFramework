...
public class Demo2 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(new ByAll(By.id("cyclosPassword"),By.name("password"))).sendKeys("1234");
...
//		new Select(groupList).selectByValue("20");
		...
		driver.findElement(By.xpath(".//*[@id='tdContents']/form/table[1]/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/input")).sendKeys("TraineeUser3");
		driver.findElement(By.xpath(".//*[@id='tdContents']/form/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td[2]/input")).sendKeys("TraineeUser3");
		driver.findElement(By.xpath(".//*[@id='tdContents']/form/table[1]/tbody/tr[2]/td/table/tbody/tr[4]/td[2]/input")).sendKeys("TraineeUser3@gmail.com");
